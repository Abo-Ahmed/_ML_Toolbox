...
handler.read_real('/content/drive/MyDrive/eng-mahmoud/dataSet/danbooru2019/images/512px/0000' , 224 , 224 , 1)
# handler.read_sample(None , 224 , 224) # datapath , width , height
